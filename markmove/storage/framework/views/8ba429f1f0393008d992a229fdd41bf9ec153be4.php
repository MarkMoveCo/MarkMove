                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="male" type="radio" name="gender" value="male" > <label class="control-label" for="male">Male</label>
                                <input id="female" type="radio" name="gender" value="female"> <label class="control-label" for="female">Female</label>
